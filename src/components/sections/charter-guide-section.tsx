      ...
      <div className="container mx-auto px-4">
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative aspect-[16/10] mb-10">
            <Image
              src="https://images.prismic.io/alphas/aQUGHLpReVYa35qv_Gemini_Generated_Image_48db5n48db5n48db.png?auto=format,compress"
              alt="Bombay Yacht 5-Step Guide to Charter"
              fill
          ...
          <div className="text-center max-w-3xl mx-auto">
            <p className="text-lg text-[#666666] leading-relaxed mb-8">
              Are you planning your first yacht charter, after years of dreaming of the experience, and looking for a place to start? Find out everything you need to know about planning your luxury yacht charter in the Bombay Yacht 5-Step Guide to Charter.
            </p>
