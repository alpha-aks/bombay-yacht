        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="relative aspect-[16/10] mb-10">
            <Image
              ...
              alt="Bombay Yacht Luxury Charter Portfolio"
              fill
          ...
          <div className="text-center max-w-3xl mx-auto">
            <p className="text-lg text-[#666666] leading-relaxed mb-8">
              Bombay Yacht's annual publication showcases some of the most beautiful superyachts available to charter around the world as well as the destinations open to you, exclusive interviews and expert insights into the world of yachting today.
            </p>
